...
<p align="center">
  <img src="https://github.com/XuminGaoGithub/Automated-Pest-Counting-in-Water-Traps-through-Active-Robotic-Stirring-for-Occlusion-Handling/blob/main/Grounded-Segment-Anything-Yolov5/overview_C6_v2.jpg" width="700" height="1000"" />
</p>
...
ros2 launch moveit2_commander_recorder moveit_test.launch.py shape:=round video_name:=low_round_5 #Running example, can chose different patterns, different density and rename video, so that collect all of videos with different stirring patterns.
...
copy ./Annotations & ./yellow_pan_xxx_density_shapes (rename as ./JPEGImages) to ./dataset/voc20xx, and set up /voc20xx/ImageSets
...
#If do not want the bounding box confidence score, uncomment the line below and set confidence to None.
