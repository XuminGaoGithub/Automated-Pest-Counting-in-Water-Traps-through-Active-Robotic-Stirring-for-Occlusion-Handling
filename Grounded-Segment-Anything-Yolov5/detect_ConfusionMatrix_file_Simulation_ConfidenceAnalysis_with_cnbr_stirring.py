...
def run(
    ...
    counting_result_information = open("counting_result_information.txt", 'a')
    num = 0
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            counting_result_information.write(file_name + '.jpg' + ',' + str(mean_confidence_value) + ',' + str(len(det)) + ',' + str(
                blurriness) + ',' + str(Realiability) + ','+ str(tp) + ',' + str(fp) + ',' + str(fn) + ',' + str(gt_image) + ',' + str(gt_real) + '\n')
