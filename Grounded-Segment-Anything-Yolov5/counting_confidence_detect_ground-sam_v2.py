'''
python counting_confidence_detect_ground-sam_v2.py --config GroundingDINO/groundingdino/config/GroundingDINO_SwinT_OGC.py --grounded_checkpoint /home/xumin/Open-GroundingDino/weights/groundingdino_swint_ogc.pth --sam_hq_checkpoint /home/newdrive/summerschool/Grounded-Segment-Anything/sam_hq_vit_b.pth --use_sam_hq  --input_dir ./counting_confidence/src --output_dir "./simulation_output/image_processing" --box_threshold 0.5 --text_threshold 0.25 --device "cuda" --weights /home/newdrive/Phd/Modification_yolov5/runs/train/voc2060_yolov5s-ODConv-cotnet2/weights/best.pt --device_yolo 0 --save-txt --save-conf --source ./counting_confidence/yellow_pan
...
def save_output_with_opencv_boxes(original_frame, boxes, phrases, output_path):
    ...
    try:
        ...
        print(f"Save detection to: {output_path}")
    except Exception as e:
        raise RuntimeError(f"Save detection failed: {str(e)}")
...
def save_output_with_opencv_boxes_(original_frame, boxes, phrases, output_path):
    ...
    try:
        ...
        raise RuntimeError(f"save detection image failed: {str(e)}")
            ...
            if crop_img is not None:
                ...
                for path, im, im0s, vid_cap, s in dataset:
                    ...
                    for i, det in enumerate(pred):  # per image
                        ...
                        #/home/newdrive/Phd/Grounded-Segment-Anything-Yolov5/utils/plots.py
