...
if __name__ == '__main__':
    ...
    img_path = './dataset/voc2080/JPEGImages/'
    Annotations_path = './dataset/voc2080/Annotations'  # gt_Annotations_VOC_format
    label_path = './dataset/voc2080/labels/'  # gt_Annotations_yolo_format
    predict_path = '/home/newdrive/Phd/Grounded-Segment-Anything-Yolov5/dataset/voc2080/pred_labels'  # "'./runs/detect/counting_confidence_high_density_speed_without_conf/pred_labels' #pred_labels
    save_path = '/home/newdrive/Phd/Grounded-Segment-Anything-Yolov5/dataset/voc2080/vis_TPFPFN'

    classes = ['aphid']
    detect_color, missing_color, error_color = (0, 255, 0), (0, 0, 255), (255, 0, 0)
    iou_threshold = 0.5 #yolov5中使用的iou_thres=0.45
    ...
    with open('counting_result_information.txt', 'w') as f_w:
        for path in tqdm.tqdm(os.listdir(label_path)):
            ...
            if label is not None:
                ...
                gt_real = 18 #6，12，18 # gt number of aphids in the yellow pan
